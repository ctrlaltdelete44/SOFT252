...
public class Admin extends Account implements Serializable, IViewAccounts{
     ...
     * @return - returns the account information of the accounts the admin can view
     */
    @Override
     ...
     * @param last - surname
     * @param address - address
     * @param arrPassword - password as an array of char as this is how the password box creates it
    ...
    public void deleteAccount(String accountInformation)
    {
        ...
        AccountSingleton.getOrCreate().remove(aa.convert());
    }
