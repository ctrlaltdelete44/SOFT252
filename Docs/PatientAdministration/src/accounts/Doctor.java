...
public class Doctor extends Account implements Serializable, IViewAvailability{
    ...
    /**
     * doctor can receive feedback from a patient. this method processes it
     * by adding it to the list of feedback with the doctor and calculating a new
     * mean for their rating
     * @param feedback - the feedback from patients, with an associated message and rating
    ...
    public double provideFeedback(Feedback feedback)
    {
        ...
        //System.out.println("Feedback added to doctor");
    ...
    /**
     * method for viewing both free dates and booked dates for this doctor.
     * has to be seperate from both other methods as this returns them in order
     * of date
    ...
    private Appointment getAppointment(LocalDate date)
    {
       ...
       {
           //System.out.println("Searching appointment between " + a.getDoctor().getFirstName() + " and " + a.getPatient().getFirstName() + " on " + a.getDate());
           if (a.getDate().equals(date))
           {
               //System.out.println("Returning appointment here:DOCTOR");
               return a;
           }
       }
    ...
    /**
     * beginning of methods involved with processing the outcomes of an appointment
     * if a prescription is assigned AND a further appointment needed, this method called
     * 
     ...
     * @param timeQuantity - number of days/months/years in the future that the next appointmnt is booked for 
    ...
    {        
        ...
        //System.out.println("Prescription of " + prescription.getQuantity() + " " + prescription.getMedicine() + " and appointment on " + appointmentDate);
    ...
    /**
     * if no further action is required following a consultation, this method called
    ...
    {        
        //removes date from availability if present
    ...
    {
        appointments.removeAppointment(appointments.getAppointment(uniqueId, date));
    }
    
    /**
     * used solely for debugging
     */
    public void getAvailabilityData()
    {
        //System.out.println("\n----------\nDoctor " + firstName + " " + surname + " has:\n");
        //System.out.println(availability.getNumberOfAvailableDays() + " available");
    }
