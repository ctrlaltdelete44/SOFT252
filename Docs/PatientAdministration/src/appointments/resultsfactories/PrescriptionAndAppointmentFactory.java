 ...
 * @author davie
 */
public class PrescriptionAndAppointmentFactory extends AbstractResultsFactory {
     ...
     */
    public PrescriptionAndAppointmentFactory(String strNotes) {
        super(strNotes);
    }
    
    /**
     * used twice to add the outcomes of the consultation, with a switch statement
