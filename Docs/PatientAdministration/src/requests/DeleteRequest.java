...
public class DeleteRequest extends Request implements Serializable {
    ...
    /**
     * in processing, will remove the patient from the account tracker and
     * cleanly delete the patient (clearing any appointments and floating requests)
    ...
    public String process()
    {
        ...
        p.cleanDelete();
        AccountSingleton.getOrCreate().remove(p);
