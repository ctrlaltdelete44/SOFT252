...
public abstract class Request implements Serializable, IObserver {
    ...
    public void untrackRequest()
    {
        ...
        //System.out.println("Removing request from tracker");
    }
    
    /**
     * default constructor, as all requests have this basic info associated with them
    ...
    public Request(Account a, RequestType rt)
    {
        account = a;
        requestType = rt;
        //System.out.println("Request of " + a.getFirstName() + " created");
    }
    ...
    /**
     * abstract method for processing a request, as each request type handles this differently
