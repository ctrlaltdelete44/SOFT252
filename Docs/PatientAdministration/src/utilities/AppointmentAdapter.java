...
/**
 * a class to retrieve an appointment given a doctor and a summary of appointment information
 * @author davie
 */
public class AppointmentAdapter implements IConvert {
    ...
    /**
     * searches through a list of that doctors appointments,
     * with validation to ensure that the patient and date are both accurate
     * before returning a reference to the appointment
