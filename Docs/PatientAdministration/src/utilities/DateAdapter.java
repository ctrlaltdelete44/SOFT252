...
public class DateAdapter implements IConvert {
    ...
    /**
     * the input string is always of a set format, and the convert method gradually
     * breaks it down until it can retrieve the date, month, and year. it then
     * converts this into a local date
